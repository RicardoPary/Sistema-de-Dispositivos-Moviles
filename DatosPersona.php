...
$sql2=$cn->prepare("SELECT * FROM persona WHERE NumeroDocumento=:Numero");
...
<thead>
  ...
  <tr>
    ...
    <td width="131"><span class="Estilo11"><?php echo $Datos['NumeroDocumento']; ?></span></td>
    <td width="10"><span class="Estilo5"></span></td>
    <td width="72"><span class="Estilo4">
	<a href=""><img src="Imagenes/sign-up-icon.png" width="18" height="18" style="margin-bottom:-5px; margin-left:5px;"/></a></span></td>
    <td width="11">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><span class="Estilo5"></span></td>
    <td><span class="Estilo4"><a href=""><img src="Imagenes/sign-up-icon.png" width="18" height="18" style="margin-bottom:-5px; margin-left:5px;"/></a></span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
